...
Public Class BombTechComputer
    ...
    Protected Overrides Sub SetMinReqProps()
        ...
        Dim yTemp(,) As Byte = {{8, 0, 0, 0, 0, 0, 6, 0, 7, 0, 8, 10}}
    ...
    Protected Overrides Function GetCoefficient(ByVal lLookup As TechBuilderComputer.elPropCoeffLookup) As Decimal
        ...
        If ofrm Is Nothing = False Then
            Dim decTemp(decCoeffList.GetUpperBound(0)) As Decimal
            For X As Int32 = 0 To decCoeffList.GetUpperBound(0)
                decTemp(X) = decCoeffList(X)
            Next X
