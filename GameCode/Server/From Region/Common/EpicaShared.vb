...
Public Class NetSock
    ...
    Public Sub SendData(ByVal Data() As Byte)
        Try
            If moSocket Is Nothing = False AndAlso moSocket.Connected = True Then
    ...
    Public Sub SendLenAppendedData(ByVal Data() As Byte)
        ...
        Try
            If moSocket.Connected = True Then moSocket.BeginSend(Data, 0, Data.Length, 0, AddressOf SendDataCallback, moSocket)
        Catch
            RaiseEvent onError(SocketIndex, Err.Description)
            Exit Sub
        End Try
