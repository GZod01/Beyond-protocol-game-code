...
'			Try
'				sSQL = "INSERT INTO tblSenateProposalVote (ProposalID, VoterID, VoteValue) VALUES (" & lProposalID & ", " & _
'				  VoterID & ", " & CByte(yVote) & ")"
...
'			Return "INSERT INTO tblSenateProposalVote (ProposalID, VoterID, VoteValue) VALUES (" & lProposalID & ", " & _
'			 VoterID & ", " & CByte(yVote) & ")"
'		Catch ex As Exception
'			LogEvent(GlobalVars.LogEventType.CriticalError, "Unable to save object SenateSystemVote. Reason: " & ex.Message)
'		End Try
