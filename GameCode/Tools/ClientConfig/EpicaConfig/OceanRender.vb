...
Public Class OceanRender
	...
	Public Function PrepareEffect() As Int32
	...
	Private Sub ValidateTextures()
		If moNormalMap Is Nothing OrElse moNormalMap.Disposed = True Then
			Device.IsUsingEventHandlers = False
			'moNormalMap = TextureLoader.FromFile(moDevice, "C:\Program Files\NVIDIA Corporation\SDK 9.5\MEDIA\textures\2D\waves2.dds")
			moNormalMap = moResMgr.GetTexture("waves2.dds", EpicaResourceManager.eGetTextureType.NoSpecifics, "pring.pak")
	...
	Public Sub New(ByRef oDevice As Device)
		...
		Dim oStream As System.IO.Stream = oAssembly.GetManifestResourceStream("ClientConfig.Ocean.fx")
		Device.IsUsingEventHandlers = False
		moEffect = Effect.FromStream(oDevice, oStream, Nothing, ShaderFlags.None, Nothing)
	...
	Public Sub SetAsPlanetType(ByVal yPlanetType As Byte, ByVal lCellSpacing As Int32)
		...
		'End Select
	End Sub
	Public Sub SetFromLightVec(ByVal vecDir As Vector3)
