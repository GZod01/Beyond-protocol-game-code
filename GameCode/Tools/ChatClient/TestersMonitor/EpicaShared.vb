...
#End Region
    ...
    Public Const gb_IN_OPEN_BETA As Boolean = True

    Public Const gl_BP_CLIENT_VERSION As Int32 = 311
    Public Const gl_SA_CLIENT_VERSION As Int32 = 308
...
Public Class NetSock
    ...
    Public Sub Connect(ByVal sHostIP As String, ByVal lPortNumber As Int32)
        ...
        Try
            ...
            If oHost Is Nothing = False Then
